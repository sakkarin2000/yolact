...
def evalimage(net: Yolact, path: str, save_path: str = 'test' ):
    ...
    confident=preds[0]['detection']['score'][0]
    ...
    if save_path is None:
        ...
        cv2.imwrite(path.rsplit('/', 1)[-1],img_numpy)
...
def evalimages(net: Yolact, input_folder: str, output_folder: str):
    ...
    print('')
    print(confmet)
    print('unripe precision = ',(confmet[0][0]/(confmet[0][0]+confmet[0][1]+confmet[0][2]+not_detect[0])))
    print('medium precision = ', (confmet[1][1] / (confmet[1][0] + confmet[1][1] + confmet[1][2]+not_detect[1])))
    print('ripe precision = ', (confmet[2][2] / (confmet[2][0] + confmet[2][1] + confmet[2][2]+not_detect[2])))
    ...
    print('accuracy of classifier', (confmet[0][0]+confmet[1][1]+confmet[2][2])/(confmet[0][0]+confmet[0][1]+confmet[0][2]+confmet[1][0]+confmet[1][1]+confmet[1][2]+confmet[2][0]+confmet[2][1]+confmet[2][2]+not_detect[0]+not_detect[1]+not_detect[2]))
    print('not detect = ', not_detect)
    print('')
    print('Done.')
