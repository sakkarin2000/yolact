...
papaya_dataset = dataset_base.copy({
    'name': 'Papaya Project',
    'train_info': 'C:/Users/Windows10/Desktop/Yolact/yolact/papaya_dataset/train/coco_instances.json',
...
yolact_resnet50_papaya_config = yolact_resnet50_config.copy({
    'name': 'yolact_plus_resnet50_papaya',
    # Dataset stuff
    'dataset': papaya_dataset,
    'num_classes': len(papaya_dataset.class_names) + 1,
